...
class CompteDao
{
  ...
  {
    $req = $this->db->prepare('INSERT INTO clients (nom, prenom, adresse, ville, province, codePostal, login, motDePasse, email) VALUES (:nom, :prenom, :adresse, :ville, :province, :codePostal, :login, :motDePasse, :email)');
    ...
    $req->bindValue(':motDePasse', $compte->getMotDePasse(), PDO::PARAM_STR);
